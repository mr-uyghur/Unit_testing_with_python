...
# system test that tests through entire system
...
class AppTest(TestCase):
    def setUp(self): #this set up will run for each test case
    ...
    def test_menu_prints_promp(self):
        with patch('builtins.input',return_value = 'q') as mocked_input:
            app.menu()
            mocked_input.assert_called_with(app.MENU_PROMP)
